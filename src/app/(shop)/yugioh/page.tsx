...
export default async function YugiohPage({
  ...
  const category = getCategoryBySlug("yugioh")!;
  const { products, total } = getProductsByCategory("yugioh", {
  ...
  return (
    <div className="mx-auto max-w-7xl px-4 py-8">
      <Breadcrumbs items={[{ label: "Yu-Gi-Oh!" }]} />
      <div className="mb-8 flex items-center gap-4">
        {/* eslint-disable-next-line @next/next/no-img-element */}
        <img src="/logos/yugioh.png" alt="Yu-Gi-Oh! TCG" className="h-10" />
        <div>
